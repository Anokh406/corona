...
$('.editStudentsRecord').on('click', function (e) {
  ...
  console.log(recordId);
  $('#updateStudents').find('#updateStudent').val(recordId);
  $('#updateStudents').find('#sname').val(sName);
  $('#updateStudents').find('#fname').val(fName);
  $('#updateStudents').find('#mName').val(mName);
  $('#updateStudents').find('#email').val(email);
  $('#updateStudents').find('#mobile').val(mobile);
  $('#updateStudents').find('#roll_no').val(r_No);
  $('#updateStudents').find('#addmission').val(addmision);
  $('#updateStudents').find('#aadhar').val(aadharNo);
  $('#updateStudents').find('#ppp').val(familyId);
  $("#MyPopup").modal('show');
});
