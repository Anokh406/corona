<!-- <div class="main-panel">
    ...
    <form action="functions/functions.php" method="POST" id="covidDataUpdate">
    <div class="container">
        <div class="row">
            ...
            <div class="mb-3 col-md-6 col-lg-6">
                ...
                <input type="hidden" name="covidDataUpdate">
                <input type="hidden" name="covidDetailsUpdate" id="covidDetailsUpdate">
            </div>
            <div class=" mb-3 col-md-6 col-lg-6 justify-content-center">
                ...
                <button type="button" class="btn btn-secondary  justify-content-center" id="close1">Close</button>
            </div>
        </div>
    </div>
</form>
